...
<body style="background-color:#e7ebea;">
  <div id="container">
    <form name="submitForm" method="post" action="<?php echo U('Register/hyregister');?>" id="submitForm" target="formSubmit">
      <div id="pos" >	
              ...
              <td>
                ...
                <ul>
                  ...
                  <li class="info1"><span>公司名称:&nbsp;</span>
                    <input type="text" name="cname" class="box"/>
                  </li>
                  <li class="info1"><span>公司类型:</span>
                    <select name='ctype'>
                      <option>类型选择</option>
                      <option value='0'>房产中介</option>
                      <option value='1'>汽车服务</option>
                      <option value='2'>金融担保</option>
                    </select></li>
