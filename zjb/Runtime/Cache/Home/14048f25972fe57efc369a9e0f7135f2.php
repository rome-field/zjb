...
<div id="legend" class="">
    ...
    <div class="control-group">
      ...
      <option>企业借款</option></select>
          ...
          <!-- Select Basic -->
          <label class="control-label">抵押物</label>
          <div class="controls">
            <select class="input-xlarge">
      <option>有</option>
      <option>无</option></select>
          </div>

        </div><div class="control-group">

          <!-- Text input-->
          <label class="control-label" for="input01">利率</label>
          <div class="controls">
            <input type="text" placeholder="placeholder" class="input-xlarge">
            <p class="help-block"></p>
          </div>
    ...
    <div class="control-group">
      ...
      <option>1-3个月</option>
      <option>4-6个月</option>
      <option>7-12个月</option>
      <option>一年以上</option></select>
          </div>
