				  ...
				  <table   width="90%" class="logintable">
					...
					<tr id="usernametr" height="60">
						...
						<td>
							<ul>
								<li class="info"></li>
								<li class="info1"><span>用户类型:&nbsp;</span><div style="text-align: left;"><input type="radio" value="会员登录" name="group" checked="checked">会员登录<input type="radio" value="个人登录" name="group" checked="checked">个人登录</div></li>
					...
					<tr height="0px">
						  ...
						  <td style="padding-right:50pt;" >
							  ...
							  </span><span class="reg-a" border="2"><a href="/reg">免费注册</a>|<a href="/forgetpassword" id="herf">找回密码</a> </span>
						  </td>
					  </tr>
				  </table>
				</div>
