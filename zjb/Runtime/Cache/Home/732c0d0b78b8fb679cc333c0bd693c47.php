	...
	<div id="header">
			...
			<form class="form-search form-inline"><input class="input-medium search-query" type="text" /><button class="btn" contenteditable="true" type="submit">查找</button></form> 
				...
				<div id='c2'>
					...
					<a class="navbar-brand" href="#">来源 :</a>							
						...
						<a class="navbar-brand" href="#">期限 :</a>							
						<ul class="nav nav-pills navbar-brand">
							<li class="active"><a href="#">不限</a></li>
							<li><a href="#">1个月以下</a></li>
							<li><a href="#">1-3个月</a></li>
							<li><a href="#">4-6个月</a></li>
							<li><a href="#">7-12个月</a></li>
							<li><a href="#">一年以上</a></li>
						</ul>
	 ...
	 <div id="footer">
			...
			<div class="b1" id="1">
				...
				<a href="<?php echo U('Company/company');?>#desc" target="_blank"><img src="__ROOT__/Tpl/public/images/eshop_service.jpg" alt="" /></a>
			...
			<div class="b1" id="2">
				...
				<img src="__ROOT__/Tpl/public/images/eshop_service.jpg" alt="" />
